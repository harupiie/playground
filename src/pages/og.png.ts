...
export const GET: APIRoute = async () => {
  ...
  const badge = (text: string, bg: string, color: string) => ({
    type: 'div',
    props: {
      style: { display: 'flex', background: bg, color, padding: '6px 20px', borderRadius: '9999px', fontSize: '22px', fontWeight: 700 },
      children: text,
    },
  });
      ...
      props: {
        ...
        children: [
          ...
          },
          {
            type: 'div',
            props: {
              style: { display: 'flex', fontSize: '88px', fontWeight: 700, color: '#ffffff', lineHeight: 1.1, marginBottom: '28px' },
          ...
          },
          {
            type: 'div',
            props: {
              style: { display: 'flex', fontSize: '34px', color: '#9ca3af', fontWeight: 400 },
